...
const yrllan_simplesendmail_1 = __importDefault(require("yrllan-simplesendmail"));
const template_1 = __importDefault(require("yrllan-simplesendmail/templates/template"));
...
const message = {
    ...
    // optional
    subject: 'only a test',
    // you should choose the template here and put its options
    html: template.confirmEmail(confirmEmailOptions),
};
// sending the email
const sender = new yrllan_simplesendmail_1.default(config);
