function confirm_email_01(title: string, code:number){
    ...
    <p style="color: #666666; margin-bottom: 10px;">Seu código de confirmação é: ${code}</p>
    <p style="font-size: 24px; font-weight: bold; color: #333333; margin-top: 30px; margin-bottom: 40px;">123456</p>
